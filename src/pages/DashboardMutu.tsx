...
const DashboardMutu: React.FC = () => {
  ...
  return (
    <div className="flex-grow h-screen overflow-hidden w-full bg-gradient-to-br from-[#f0f2f8] via-[#eef0f8] to-[#f3f0fb] flex flex-col">
      <Header 
        title="Dashboard Mutu" 
        subtitle="Monitoring Capaian Indikator Mutu RS" 
      />

      <div className="flex-grow overflow-y-auto p-8 px-10">
        <div className="max-w-[1600px] mx-auto w-full">
          {!isUnlocked ? (
            <div className="flex justify-center items-center py-20 bg-white/40 backdrop-blur-md border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.03)] rounded-[30px]">
